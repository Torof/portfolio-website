      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1 overflow-hidden">
          <motion.div
            ...
            animate={{ x: `calc(-${currentIndex} * (33.333% + 5.333px))` }}
            transition={{ type: 'spring', stiffness: 300, damping: 30 }}
          >
            {projects.map((project) => (
              <div
                key={project.id}
                className="flex-shrink-0 w-[calc(33.333%-10.667px)]"
              >
                <div
                  className={`flex flex-col p-4 rounded-lg border transition-all duration-300 h-full ${
                    theme === 'theme-light'
