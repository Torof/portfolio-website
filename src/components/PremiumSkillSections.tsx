      ...
      <motion.div 
        ...
        animate={isShuffling ? {
          borderColor: theme === 'theme-light' 
            ? ['rgba(147, 197, 253, 0.5)', 'rgba(147, 197, 253, 0.8)', 'rgba(147, 197, 253, 0.5)']
            ...
            <div className="flex items-center space-x-4">
              <div className="text-center">
                ...
                <motion.button
                  ...
                  } ${isShuffling ? 'opacity-75 cursor-not-allowed' : 'hover:shadow-xl'}`}
                  whileHover={!isShuffling ? { scale: 1.05 } : {}}
                  whileTap={!isShuffling ? { scale: 0.95 } : {}}
                  title="Spin the wheel to randomly select a standard"
                >
                  {isShuffling ? 'Spinning...' : 'Random'}
                </motion.button>
              </div>
