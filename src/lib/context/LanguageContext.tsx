...
const translations = {
  en: {
    ...
    'experience.skillsUsed': 'SKILLS USED',
    ...
    'projects.githubStats': 'GitHub Stats',
    ...
    'projects.projectsDescription': 'A collection of my blockchain and web3 projects, showcasing smart contract development, DeFi protocols, and decentralized applications.',
    'projects.somePublishedProjects': 'Published Projects',
    'projects.githubRepositories': 'GitHub Repositories',
    ...
    'exp.ledgity.achievement.1': 'Developed <strong>robust, secure smart contracts</strong> using <strong>Solidity on Ethereum L1 and L2</strong>.',
    'exp.ledgity.achievement.2': 'Conducted <strong>code reviews and audits</strong> to ensure <strong>high-quality, bug-free code</strong> before deployment.',
    'exp.ledgity.achievement.3': 'Integrated <strong>decentralized applications (dApps)</strong> with smart contracts to enhance user experience.',
    'exp.ledgity.achievement.4': 'Managed the <strong>deployment and maintenance</strong> of smart contracts on <strong>multiple blockchain networks</strong>.',
    'exp.ledgity.achievement.5': 'Developed <strong>user-friendly interfaces</strong> for complex blockchain functions to improve accessibility.',
    ...
    'exp.freelance.achievement.1': 'Created a <strong>staking contract for NFTs</strong> that successfully minted <strong>over 21 million ERC20 tokens</strong> and currently holding <strong>1400+ NFTs in staking</strong>.',
    'exp.freelance.achievement.2': 'Developed and deployed <strong>decentralized applications on EVM Blockchains</strong> using <strong>Solidity, React.js, Next.js</strong>.',
    'exp.freelance.achievement.3': 'Collaborated with clients to define project requirements and deliver <strong>scalable solutions</strong>.',
    'exp.freelance.achievement.4': 'Integrated <strong>oracles for real-time data feeds</strong> into smart contracts.',
    'exp.freelance.achievement.5': 'Created and managed <strong>ERC-20 and ERC-721 token standards</strong> for various projects.',
    'exp.freelance.achievement.6': 'Conducted thorough testing using frameworks like <strong>Foundry and Hardhat</strong>.',

    'exp.tasc.position': 'CEO',
    'exp.tasc.description': 'Founded and led a company developing a Play-to-Earn blockchain game.',
    'exp.tasc.achievement.1': 'Founded a company to build a <strong>P2E game</strong> and led a team of developers using <strong>Agile methodologies (SCRUM)</strong>.',
    'exp.tasc.achievement.2': 'Developed and implemented <strong>strategic vision</strong> to drive company growth and profitability.',
    'exp.tasc.achievement.3': 'Managed <strong>crisis communications</strong> effectively to maintain brand integrity.',
    'exp.tasc.achievement.4': 'Developed <strong>smart contracts for in-game assets</strong> using Solidity.',
    'exp.tasc.achievement.5': 'Implemented an <strong>Ethereum-based token economy</strong> to enhance player engagement.',
    ...
    'exp.future-institution.achievement.1': 'Led the development of <strong>smart contracts for a Blockchain game</strong>.',
    'exp.future-institution.achievement.2': 'Led the design and implementation of <strong>robust smart contracts on Ethereum</strong>.',
    'exp.future-institution.achievement.3': 'Implemented <strong>token standards, including ERC20 and ERC721</strong>, to facilitate token creation and management.',
    ...
    'exp.bitcoin-vietnam.achievement.1': 'Researched <strong>ERC20 tokens</strong>, and created an <strong>ERC20 token for the company</strong>.',
    'exp.bitcoin-vietnam.achievement.2': 'Collaborated with a team to develop <strong>decentralized applications (dApps)</strong> using Ethereum blockchain.',
    'exp.bitcoin-vietnam.achievement.3': 'Assisted in <strong>smart contract development using Solidity</strong> to automate processes and enhance security.',
    'exp.bitcoin-vietnam.achievement.4': 'Maintained the <strong>front-end of the website</strong>',
    ...
    'exp.chiliz-hackathon.achievement.1': 'Developed <strong>full-stack dApp</strong> with <strong>React TypeScript frontend</strong>',
    'exp.chiliz-hackathon.achievement.2': 'Implemented <strong>smart contracts for talent verification and rewards</strong>',
    'exp.chiliz-hackathon.achievement.3': 'Created <strong>backend API with Handlebars templating</strong>',
    'exp.chiliz-hackathon.achievement.4': 'Delivered <strong>working prototype within hackathon timeframe</strong>',
    'exp.chiliz-hackathon.achievement.5': 'Team name: <strong>RedCodeChilizPeppers</strong>',
    ...
    'exp.eth-global-hackathon.achievement.1': 'Developed <strong>on-chain identity management platform</strong> using <strong>Soul Bound Tokens (SBT)</strong>',
    'exp.eth-global-hackathon.achievement.2': 'Implemented <strong>Token Bound Accounts (TBA)</strong> with <strong>ERC6551 standard</strong>',
    'exp.eth-global-hackathon.achievement.3': 'Integrated <strong>Account Abstraction using ERC4337</strong>',
    'exp.eth-global-hackathon.achievement.4': 'Deployed across <strong>multiple testnets: Scroll Sepolia, Mantle, Mumbai Polygon</strong>',
    'exp.eth-global-hackathon.achievement.5': 'Created <strong>live demo at aatba.org</strong>',
    'exp.eth-global-hackathon.achievement.6': 'Collaborated with <strong>international team of 5 developers</strong>',
    ...
    'exp.careerzen-hackathon.achievement.1': 'Created <strong>career NFT system</strong> for <strong>verified work history and certifications</strong>',
    'exp.careerzen-hackathon.achievement.2': 'Implemented <strong>privacy-preserving profile sharing</strong> with approval mechanism',
    'exp.careerzen-hackathon.achievement.3': 'Built <strong>anonymous professional networking features</strong> for Asian job market needs',
    'exp.careerzen-hackathon.achievement.4': 'Tackled <strong>gasless transaction implementation</strong> with <strong>ecrecover signature verification</strong>',
    'exp.careerzen-hackathon.achievement.5': 'Enabled <strong>third-party career validation</strong> from mentors, hackathons, and instructors',
    ...
    'skills.techStack.riverView': '🌊 River View',
    'skills.techStack.listView': '📋 List View',
    'skills.techStack.gridView': '🔲 Grid View',
    ...
    // Skill Section Cards
    'skills.section.expand': 'Expand',
    'skills.section.collapse': 'Collapse',
    'skills.section.standards': 'Standards',
    'skills.section.standard': 'Standard',
    'skills.section.category': 'Category',
    'skills.section.description': 'Description',
    'skills.section.expertise': 'Expertise',
    'skills.section.expert': 'Expert',
    'skills.section.advanced': 'Advanced',
    'skills.section.intermediate': 'Intermediate',
    'skills.section.beginner': 'Beginner',
    'skills.smartContracts.title': 'Smart Contract Expertise',
    'skills.smartContracts.description': 'With over 7 years of experience as a smart contract developer, I have comprehensive knowledge of all major ERC standards and blockchain development patterns. I specialize in building secure, gas-optimized contracts for <strong>DeFi protocols</strong>, <strong>NFT platforms</strong>, and more. Deep expertise across the full spectrum of <strong>Ethereum standards</strong> including token standards, governance mechanisms, proxy patterns, and advanced DeFi primitives.',
    'skills.smartContracts.tableTitle': 'ERC Standards & Contract Patterns',
    'skills.security.title': 'Smart Contract Security & Auditing',
    'skills.security.description': 'With extensive experience in smart contract security, I specialize in identifying and mitigating vulnerabilities before they become exploits. My approach combines <strong>manual code review</strong>, <strong>automated static analysis</strong>, and <strong>property-based testing</strong> to ensure comprehensive security coverage. I have deep knowledge of common attack vectors including <strong>reentrancy</strong>, <strong>flash loan attacks</strong>, <strong>MEV exploitation</strong>, <strong>oracle manipulation</strong>, and more. Using industry-standard tools like <strong>Slither</strong>, <strong>Foundry</strong>, and <strong>Echidna</strong>, I conduct thorough security audits and implement robust defense mechanisms to protect protocols and their users.',
    'skills.defi.title': 'DeFi Protocol Expertise',
    ...
    'community.cardTitle': 'Stack Exchange Contributions',
    'community.description': 'Active contributor to the <strong>Ethereum Stack Exchange</strong> community, helping developers solve complex smart contract and blockchain problems. With <strong>{reputation} reputation</strong> and <strong>{silver} silver</strong> and <strong>{bronze} bronze badges</strong>, I provide detailed technical answers on topics including <strong>Solidity</strong>, <strong>EVM</strong>, <strong>NFTs</strong>, and <strong>smart contract security</strong>. My contributions focus on practical solutions to real-world blockchain development challenges, sharing knowledge gained from years of hands-on experience building production smart contracts.',
  ...
  fr: {
    ...
    'experience.skillsUsed': 'COMPÉTENCES UTILISÉES',
    ...
    'projects.githubStats': 'Stats GitHub',
    ...
    'projects.projectsTitle': 'Projets',
    'projects.projectsDescription': 'Une collection de mes projets blockchain et web3, mettant en valeur le développement de smart contracts, protocoles DeFi et applications décentralisées.',
    'projects.somePublishedProjects': 'Projets Publiés',
    'projects.githubRepositories': 'Dépôts GitHub',
    ...
    'exp.ledgity.achievement.1': 'Développé des <strong>smart contracts robustes et sécurisés</strong> utilisant <strong>Solidity sur Ethereum L1 et L2</strong>.',
    'exp.ledgity.achievement.2': 'Effectué des <strong>révisions de code et audits</strong> pour garantir un <strong>code de haute qualité, sans bugs</strong> avant le déploiement.',
    'exp.ledgity.achievement.3': 'Intégré des <strong>applications décentralisées (dApps)</strong> avec des smart contracts pour améliorer l\'expérience utilisateur.',
    'exp.ledgity.achievement.4': 'Géré le <strong>déploiement et la maintenance</strong> de smart contracts sur <strong>plusieurs réseaux blockchain</strong>.',
    'exp.ledgity.achievement.5': 'Développé des <strong>interfaces conviviales</strong> pour des fonctions blockchain complexes afin d\'améliorer l\'accessibilité.',
    ...
    'exp.freelance.achievement.1': 'Créé un <strong>contrat de staking pour les NFTs</strong> qui a avec succès minté <strong>plus de 21 millions de tokens ERC20</strong> et détient actuellement <strong>plus de 1400 NFTs en staking</strong>.',
    'exp.freelance.achievement.2': 'Développé et déployé des <strong>applications décentralisées sur les blockchains EVM</strong> utilisant <strong>Solidity, React.js, Next.js</strong>.',
    'exp.freelance.achievement.3': 'Collaboré avec les clients pour définir les exigences du projet et livrer des <strong>solutions évolutives</strong>.',
    'exp.freelance.achievement.4': 'Intégré des <strong>oracles pour les flux de données en temps réel</strong> dans les smart contracts.',
    'exp.freelance.achievement.5': 'Créé et géré les <strong>standards de tokens ERC-20 et ERC-721</strong> pour divers projets.',
    'exp.freelance.achievement.6': 'Effectué des tests approfondis utilisant des frameworks comme <strong>Foundry et Hardhat</strong>.',

    'exp.tasc.position': 'PDG',
    'exp.tasc.description': 'Fondé et dirigé une entreprise développant un jeu blockchain Play-to-Earn.',
    'exp.tasc.achievement.1': 'Fondé une entreprise pour construire un <strong>jeu P2E</strong> et dirigé une équipe de développeurs utilisant les <strong>méthodologies Agiles (SCRUM)</strong>.',
    'exp.tasc.achievement.2': 'Développé et implémenté une <strong>vision stratégique</strong> pour stimuler la croissance et la rentabilité de l\'entreprise.',
    'exp.tasc.achievement.3': 'Géré efficacement les <strong>communications de crise</strong> pour maintenir l\'intégrité de la marque.',
    'exp.tasc.achievement.4': 'Développé des <strong>smart contracts pour les actifs du jeu</strong> utilisant Solidity.',
    'exp.tasc.achievement.5': 'Implémenté une <strong>économie de tokens basée sur Ethereum</strong> pour améliorer l\'engagement des joueurs.',
    ...
    'exp.future-institution.achievement.1': 'Dirigé le développement de <strong>smart contracts pour un jeu Blockchain</strong>.',
    'exp.future-institution.achievement.2': 'Dirigé la conception et l\'implémentation de <strong>smart contracts robustes sur Ethereum</strong>.',
    'exp.future-institution.achievement.3': 'Implémenté les <strong>standards de tokens, incluant ERC20 et ERC721</strong>, pour faciliter la création et la gestion de tokens.',
    ...
    'exp.bitcoin-vietnam.achievement.1': 'Recherché les <strong>tokens ERC20</strong>, et créé un <strong>token ERC20 pour l\'entreprise</strong>.',
    'exp.bitcoin-vietnam.achievement.2': 'Collaboré avec une équipe pour développer des <strong>applications décentralisées (dApps)</strong> utilisant la blockchain Ethereum.',
    'exp.bitcoin-vietnam.achievement.3': 'Assisté dans le <strong>développement de smart contracts utilisant Solidity</strong> pour automatiser les processus et améliorer la sécurité.',
    'exp.bitcoin-vietnam.achievement.4': 'Maintenu le <strong>front-end du site web</strong>',
    ...
    'exp.chiliz-hackathon.achievement.1': 'Développé une <strong>dApp full-stack</strong> avec un <strong>frontend React TypeScript</strong>',
    'exp.chiliz-hackathon.achievement.2': 'Implémenté des <strong>smart contracts pour la vérification des talents et les récompenses</strong>',
    'exp.chiliz-hackathon.achievement.3': 'Créé une <strong>API backend avec le templating Handlebars</strong>',
    'exp.chiliz-hackathon.achievement.4': 'Livré un <strong>prototype fonctionnel dans les délais du hackathon</strong>',
    'exp.chiliz-hackathon.achievement.5': 'Nom d\'équipe : <strong>RedCodeChilizPeppers</strong>',
    ...
    'exp.eth-global-hackathon.achievement.1': 'Développé une <strong>plateforme de gestion d\'identité on-chain</strong> utilisant les <strong>Soul Bound Tokens (SBT)</strong>',
    'exp.eth-global-hackathon.achievement.2': 'Implémenté les <strong>Token Bound Accounts (TBA)</strong> avec le <strong>standard ERC6551</strong>',
    'exp.eth-global-hackathon.achievement.3': 'Intégré l\'<strong>Account Abstraction utilisant ERC4337</strong>',
    'exp.eth-global-hackathon.achievement.4': 'Déployé sur <strong>plusieurs testnets : Scroll Sepolia, Mantle, Mumbai Polygon</strong>',
    'exp.eth-global-hackathon.achievement.5': 'Créé une <strong>démo live sur aatba.org</strong>',
    'exp.eth-global-hackathon.achievement.6': 'Collaboré avec une <strong>équipe internationale de 5 développeurs</strong>',
    ...
    'exp.careerzen-hackathon.achievement.1': 'Créé un <strong>système de NFT de carrière</strong> pour l\'<strong>historique professionnel et les certifications vérifiés</strong>',
    'exp.careerzen-hackathon.achievement.2': 'Implémenté le <strong>partage de profil préservant la confidentialité</strong> avec mécanisme d\'approbation',
    'exp.careerzen-hackathon.achievement.3': 'Construit des <strong>fonctionnalités de réseautage professionnel anonyme</strong> pour les besoins du marché asiatique',
    'exp.careerzen-hackathon.achievement.4': 'Abordé l\'<strong>implémentation de transactions sans gas</strong> avec <strong>vérification de signature ecrecover</strong>',
    'exp.careerzen-hackathon.achievement.5': 'Permis la <strong>validation de carrière par des tiers</strong> : mentors, hackathons et instructeurs',
    ...
    'skills.techStack.riverView': '🌊 Vue Rivière',
    'skills.techStack.listView': '📋 Vue Liste',
    'skills.techStack.gridView': '🔲 Vue Grille',
    ...
    // Skill Section Cards
    'skills.section.expand': 'Développer',
    'skills.section.collapse': 'Réduire',
    'skills.section.standards': 'Standards',
    'skills.section.standard': 'Standard',
    'skills.section.category': 'Catégorie',
    'skills.section.description': 'Description',
    'skills.section.expertise': 'Expertise',
    'skills.section.expert': 'Expert',
    'skills.section.advanced': 'Avancé',
    'skills.section.intermediate': 'Intermédiaire',
    'skills.section.beginner': 'Débutant',
    'skills.smartContracts.title': 'Expertise Smart Contracts',
    'skills.smartContracts.description': 'Avec plus de 7 années d\'expérience en tant que développeur de smart contracts, j\'ai une connaissance complète de tous les standards ERC majeurs et des patterns de développement blockchain. Je me spécialise dans la construction de contrats sécurisés et optimisés en gas pour les <strong>protocoles DeFi</strong>, les <strong>plateformes NFT</strong>, et plus encore. Expertise approfondie sur tout le spectre des <strong>standards Ethereum</strong> incluant les standards de tokens, mécanismes de gouvernance, patterns de proxy, et primitives DeFi avancées.',
    'skills.smartContracts.tableTitle': 'Standards ERC & Patterns de Contrats',
    'skills.security.title': 'Sécurité & Audit de Smart Contracts',
    'skills.security.description': 'Avec une vaste expérience en sécurité des smart contracts, je me spécialise dans l\'identification et l\'atténuation des vulnérabilités avant qu\'elles ne deviennent des exploits. Mon approche combine la <strong>revue de code manuelle</strong>, l\'<strong>analyse statique automatisée</strong>, et les <strong>tests basés sur les propriétés</strong> pour assurer une couverture de sécurité complète. J\'ai une connaissance approfondie des vecteurs d\'attaque courants incluant la <strong>réentrance</strong>, les <strong>attaques par flash loan</strong>, l\'<strong>exploitation MEV</strong>, la <strong>manipulation d\'oracles</strong>, et plus encore. Utilisant des outils standards de l\'industrie comme <strong>Slither</strong>, <strong>Foundry</strong>, et <strong>Echidna</strong>, je conduis des audits de sécurité approfondis et implémente des mécanismes de défense robustes pour protéger les protocoles et leurs utilisateurs.',
    'skills.defi.title': 'Expertise Protocoles DeFi',
    ...
    'community.cardTitle': 'Contributions Stack Exchange',
    'community.description': 'Contributeur actif de la communauté <strong>Ethereum Stack Exchange</strong>, aidant les développeurs à résoudre des problèmes complexes de smart contracts et de blockchain. Avec <strong>{reputation} de réputation</strong> et <strong>{silver} badges argent</strong> et <strong>{bronze} badges bronze</strong>, je fournis des réponses techniques détaillées sur des sujets incluant <strong>Solidity</strong>, <strong>EVM</strong>, <strong>NFTs</strong>, et la <strong>sécurité des smart contracts</strong>. Mes contributions se concentrent sur des solutions pratiques aux défis de développement blockchain du monde réel, partageant les connaissances acquises après des années d\'expérience pratique dans la construction de smart contracts en production.',
